    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_id', models.PositiveIntegerField(blank=True, null=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('line1', models.CharField(blank=True, max_length=250, null=True, verbose_name='Line 1')),
                ('line2', models.CharField(blank=True, max_length=250, null=True, verbose_name='Line 2')),
                ('line3', models.CharField(blank=True, max_length=250, null=True, verbose_name='Line 3')),
                ('line4', models.CharField(blank=True, max_length=250, null=True, verbose_name='Line 4')),
